                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            ...
                            <?php  $b = get_firsts() ;?>
                             ...
                             <?php foreach($b as $frt):?>
                            <!-- FAQ Block -->
                            <div class="col-lg-4 col-md-6 faq-block faq-block-style-1">
                                <!-- FAQ Block Container -->
                                <div class="faq-block-container" style="height: auto">

                                <h4>Автор: <?=$frt['fio_athor']?></h4>
                                    <!-- Description -->
                                    <p>Книга: <?=$frt['name_book']?></p>
                                    <p>Место издания: <?=$frt['place_create']?></p>
                                    <p>Издательство: <?=$frt['creators']?></p>
                                    <p>Год издания: <?=$frt['year_crators']?></p>
                                    <p>Страниц: <?=$frt['count_pages']?></p>
